 ...
 * @author 0917c
 */
public class ViDu_1 extends javax.swing.JFrame {

    static String tenDangNhap;// gọi trực tiếp dùng static
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViDu_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
